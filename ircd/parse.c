...
struct Message msgtab[] = {
  ...
  },
  {
    ...
    "<name> <password> - Authenticate as an IRC operator. Levels: +O local, +o global, +a admin, +N netadmin, +k services root."
  },
  {
    MSG_CONNECT,
    TOK_CONNECT,
  ...
  {
  {
    ...
    "<nick> <#channel> - Force a user to join channel(s). Requires +k (Services Root)."
  },
  {
    MSG_SAPART, TOK_SAPART,
    0, MAXPARA, MFLG_SLOW, 0, NULL,
    { m_unregistered, m_not_oper, m_ignore, mo_sapart, m_ignore },
    "<nick> <#channel> [:<reason>] - Force a user to part channel(s). Requires +k (Services Root)."
  },
  {
    MSG_SANICK, TOK_SANICK,
    0, MAXPARA, MFLG_SLOW, 0, NULL,
    { m_unregistered, m_not_oper, m_ignore, mo_sanick, m_ignore },
    "<nick> <newnick> - Force a user to change their nickname. Requires +k (Services Root)."
  },
  {
    MSG_SAMODE, TOK_SAMODE,
    0, MAXPARA, MFLG_SLOW, 0, NULL,
    { m_unregistered, m_not_oper, m_ignore, mo_samode, m_ignore },
    "<nick|#channel> <modes> [params] - Force mode changes. Requires +k (Services Root)."
  },
  {
    MSG_SAQUIT, TOK_SAQUIT,
    0, MAXPARA, MFLG_SLOW, 0, NULL,
    { m_unregistered, m_not_oper, m_ignore, mo_saquit, m_ignore },
    "<nick> [:<reason>] - Force a user to disconnect. Requires +k (Services Root)."
  },
  {
    MSG_SATOPIC, TOK_SATOPIC,
    0, MAXPARA, MFLG_SLOW, 0, NULL,
    { m_unregistered, m_not_oper, m_ignore, mo_satopic, m_ignore },
    "<#channel> :<topic> - Force a topic change, bypassing +t. Requires +k (Services Root)."
  },
  {
