...
extern int mo_svsident(struct Client*, struct Client*, int, char*[]);
extern int ms_svsinfo(struct Client*, struct Client*, int, char*[]);
extern int mo_svsinfo(struct Client*, struct Client*, int, char*[]);
extern int ms_svsjoin(struct Client*, struct Client*, int, char*[]);
extern int mo_svsjoin(struct Client*, struct Client*, int, char*[]);
extern int ms_svsmode(struct Client*, struct Client*, int, char*[]);
extern int mo_svsmode(struct Client*, struct Client*, int, char*[]);
extern int ms_svsnick(struct Client*, struct Client*, int, char*[]);
extern int mo_svsnick(struct Client*, struct Client*, int, char*[]);
extern int ms_svsnoop(struct Client*, struct Client*, int, char*[]);
extern int mo_svsnoop(struct Client*, struct Client*, int, char*[]);
extern int ms_svspart(struct Client*, struct Client*, int, char*[]);
extern int mo_svspart(struct Client*, struct Client*, int, char*[]);
extern int ms_svsquit(struct Client*, struct Client*, int, char*[]);
extern int mo_svsquit(struct Client*, struct Client*, int, char*[]);
extern int ms_swhois(struct Client*, struct Client*, int, char*[]);
extern int mo_swhois(struct Client*, struct Client*, int, char*[]);
